  ...
  <div class="comfirmBox" v-if="confirmBox.boxisShow">
    ...
    <div class="test" v-if="confirmBox.isShow">
      ...
      <div class="messageBxo">
        ...
        <div class="title">
          支付到担保账户
          <img src="~@/assets/images/close.png" alt="" class="close" @click="confirmBox.isShow = false;confirmBox.boxisShow = false;">
        </div>
        <div class="realTitle">
          实际支付
        </div>
        ...
        <div class="payStyle">
          ...
          <div class="name" v-if="confirmBox.payType === 2" @click="confirmBox.isShow = false;payStyleBox.isShow = true;">{{confirmBox.str}}尾号{{confirmBox.bankCardNo | bankCardShow}}<img src="~@/assets/images/back2_icon@2x.png" alt=""></div>
      ...
      ajax({
        ...
        .then(res => {
          if (res.code === 200) {
            ...
            this.$router.push({ path: '/debt/detailsdeb', query: { id: this.confirmBox.transOrderId,wxshare:true} })
