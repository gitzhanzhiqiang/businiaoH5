 <template>
    <div class="breadcrumb" v-if="!isWeiXi">
        ...
        <span class="instructions" v-if="isWelfare==true"  @click="go()">说明</span>
    </div>
</template>
...
export default {
    ...
    created() {
        ...
        // console.log(this.$route);
            ...
            if(window.location.href.indexOf('myWelfare')>0){
                this.isWelfare=true
            }
	},
    computed: {
    ...
    methods: {
        ...
        goUrl() {
            this.$router.go(-1);
            // if(window.location.href.indexOf('mydebts')>0){
            //     this.$router.push('/my');
            // }
            // if(window.location.href.indexOf('myUnderTake')>0){
            //     this.$router.push('/my');
            // }
            // if(window.localStorage.getItem("appLogin")){
        ...
        go(){
            window.location.href='https://www.bsnzz.com/h5/useInstruction/'
        }
    }
}
</script>
