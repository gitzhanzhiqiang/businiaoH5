<template>
	<div class="cash">
		...
		<div class="btm">
			<button class="pinz" style="width:100%;" @click="getTable();imgShow = true;">查看凭证</button>
		</div>
		<!-- 查看凭证 -->
		...
		<!-- <div v-if="imgShow">
			<saveImg :url="rowData.holdConfirmImg"></saveImg>
			</div> -->
	</div>
</template>
<script>
...
.cash {
	width: 100%;
	height: 100%;
	background: rgba(246, 244, 250, 1); // overflow-y: auto;
	.details {
		width: 100%;
		height: 378px;
	}
