	...
	<div class="cash">
		...
		<div class="float">
			...
			<div class="bottom">
				...
				<!-- 标签 -->
				<div class="label">
					<div class="item" v-if="index<3" v-for="(itm,index) in rowData.labels" :key="index" :style="labelBG">{{itm.name}}</div>
				</div>
				<div class="status">
		...
		<div class="msgBox" v-if="delayData.delayShow">
			...
			<div class="msgBox_content">
				<div class="msgBox_message">
					<div style="float:left;margin-left:17px;font-size:28px;color:rgba(153,153,153,1);line-height:30px;">延长时间：</div>
					<input style="float:left;height:30px;font-size:28px;font-weight:400;width:345px;line-height:30px;" maxlength="2" :disabled="rowData.extendFlag ==1" type="text" placeholder="请输入1-24小时整数" class="saledebt-ma" v-model="delayData.params.extendTime" />
				</div>
				<div class="msgBox_message" style="margin-top:32px;margin-bottom:40px;">
					...
					<textarea :disabled="rowData.extendFlag ==1" style="float:left;margin-top:10px;height:73px;font-size:28px;font-weight:400;width:345px;" class="saledebt-ma" placeholder="请输入延长理由，帮您通知承接人~" v-model="delayData.params.remark"></textarea>
