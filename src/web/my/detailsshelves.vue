<template>
	<div class="cash">
		...
		<!-- 订单状态 -->
		<div class="state" style="margin-top:18px;margin-bottom:18px;" v-if="rowData.msg">
			<div class="item">
		...
		<div class="btm">
			<button class="pinz" style="width:100%;"  @click="$router.push({path:'/saleDebt', query:{data: JSON.stringify(rowData)}})">再次发起</button>
		</div>
	</div>
</template>
<script>
