        ...
        <div class="dateTime">
            <div class="top">
                ...
                <ul>
                    ...
                    <li>
                        <b>标的金额</b>
                        <span>{{info.bdAmount}}</span>
                    </li>
                </ul>
                <p @click="$router.push({path:'/my/editFolder',query:{id:info.id}})">></p>
            </div>
            ...
            <div style="display:none;">
            	<form :action="dizhi" enctype="multipart/form-data" method="post" ref="filet" >
                    ...
                    <input type="file" placeholder="选择图片" @change="fileChangec" id="filep" ref="filep" accept=".png,.jpg,.jpeg"/>
                </form>
            </div>
            <!-- 文件上传 -->
            <div style="display:none;">
