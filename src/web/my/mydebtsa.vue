<template>
    <div class="cash">
        ...
        <blank></blank>
        <div class="topfen">
			<p style="margin-left: 285px;font-weight: 400;border-bottom: 0;" @click="$router.push({path:'/my/mydebts',query: { id: -1 }});">P2P</p>
			<p @click="$router.push({path:'/my/mydebtsa',query: { id: 0 }});">借条</p>
		</div>
                    ...
                    <ul class="debtlist-list-ul" v-for="(item,index) in seleca" :key="index">
                        ...
                        <div class="mydebtlist" @click="titleUrl(detailurl,item)">
                            ...
                            <!--<div class="statusButton">
                                <img v-if="item.status === -1" src="~@/assets/images/readpay.png" alt="">
                                <img v-if="item.status === 12" src="~@/assets/images/readUpload.png" alt="">
                                <img v-if="item.status === 13" src="~@/assets/images/readConfirm.png" alt="">
                                <img v-if="item.status === 20" src="~@/assets/images/readAppeal.png" alt="">
                                <img v-if="item.status === 30" src="~@/assets/images/readFrozen.png" alt="">
                            </div>-->
                        </div>
                    </ul>
