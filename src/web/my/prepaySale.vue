    ...
    <div class="cash">
        ...
        <div class="payInfo">
            ...
            <div class="payItem" style="margin-bottom:40px;">
                ...
                <div class="right">¥ {{rowData.discountAmount}}</div>
            </div>
            ...
            <div class="payItem" style="margin-bottom:32px;">
                ...
                <div v-if="$route.query.originalId" class="right" style="color:rgba(248,30,30,1);">- ¥ {{couponAmount}}<img @click="$router.push({path:'/my/useCoupons',query:{id:$route.query.id,url:'/my/prepaySale'}})" src="~@/assets/images/back2_icon@2x.png" style="margin-left:26px;" alt="" srcset=""></div>
                <div v-if="couponNum&&!$route.query.originalId" class="right" style="color:rgba(248,30,30,1);">{{couponNum}}张可用<img @click="$router.push({path:'/my/useCoupons',query:{id:$route.query.id,url:'/my/prepaySale'}})" src="~@/assets/images/back2_icon@2x.png" style="margin-left:26px;" alt="" srcset=""></div>
        ...
        <div class="submitOrd" v-if="!confirmBox.isShow&&!transferShow&&!payStyleBox.isShow">
            <div class="blank"></div>
            <button class="chenjieren" v-if="rowData.status == -1" @click="confirmStep()">提交订单</button>
            <div class="times">
...
export default {
    ...
    methods: {
        ...
        tabSelectOne(index) {
            ...
            this.confirmBox.str = this.cardCheckList[index].str;
            ...
            if (this.confirmBox.payType === 2) {
                ...
                ajax({
                    ...
                    optionParams: {
                        ...
                        userCardId: this.confirmBox.userCardId,
                        callback: 'https://www.bsnzz.com/h5/page/#/my/mydebts?id=-1',
                    }
                }).post()
                    .then(res => {
                        if (res.code === 200) {
